    ...
    <div className="relative mx-auto max-w-7xl overflow-hidden rounded-3xl border border-emerald-300/15 bg-gradient-to-br from-emerald-400/[.11] via-[#0d1510] to-[#080b09] p-6 shadow-[0_0_75px_rgba(52,211,153,.08)] sm:p-10 lg:p-12">
      ...
      <div className="relative grid items-center gap-12 lg:grid-cols-[.9fr_1.1fr]">
        ...
        <motion.div initial={{ opacity: 0, x: 18 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl border border-white/[.1] bg-[#080d0a] p-4 shadow-2xl shadow-black/40 sm:p-5">
          <div className="flex items-center justify-between border-b border-white/[.07] pb-4"><div className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-[#5865F2]/15 text-[#aeb5ff]"><MessageCircle size={19} /></span><div><p className="text-sm font-bold text-white">creepy-status-bot</p><p className="mt-0.5 text-[10px] text-emerald-300">● ONLINE · 42 servers</p></div></div><span className="rounded-full bg-emerald-400/10 px-2.5 py-1 text-[10px] font-bold text-emerald-300">DEPLOYED</span></div>
