...
export function Brand({ light = false }: { light?: boolean }) {
  return <Link to="/" className="group relative z-10 inline-flex items-center gap-2.5" aria-label="Creepy Cloud home">
    ...
    <span className={`font-display text-lg font-bold tracking-tight ${light ? 'text-white' : 'text-white'}`}>Creepy <span className="text-emerald-300">Cloud</span></span>
  </Link>
}
